...
csv_jp_ind = '雇用_医療福祉_一人当たり賃金_全国_全産業.csv'
csv_jp_category = '雇用_医療福祉_一人当たり賃金_全国_大分類.csv'
csv_pref_ind = '雇用_医療福祉_一人当たり賃金_都道府県_全産業.csv'
csv_pref_lat_lon = 'pref_lat_lon.csv'

df_jp_ind = pd.read_csv(folder + csv_jp_ind, encoding = 'shift_jis')
df_jp_category = pd.read_csv(folder + csv_jp_category, encoding = 'shift_jis')
df_pref_ind = pd.read_csv(folder + csv_pref_ind, encoding = 'shift_jis')
df_lat_lon = pd.read_csv(folder + csv_pref_lat_lon)
